block RandomUniformValueSignal
  Modelica.Blocks.Noise.TruncatedNormalNoise TruncatedNormalNoise(samplePeriod = 0.1, useAutomaticLocalSeed = true, useGlobalSeed = true, y_max = y_max, y_min = y_min) annotation(
...
equation
  ...
  y = if multiProduct.y < y_min then y_min else multiProduct.y;
