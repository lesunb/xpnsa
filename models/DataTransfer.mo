block DataTransfer
  ...
  Transfer transfer(delayMax = 0.1) annotation(
...
equation
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(fillColor = {85, 85, 255}, fillPattern = FillPattern.Vertical, extent = {{-100, 100}, {100, -100}}), Text(origin = {-4, 126}, extent = {{-98, 32}, {98, -32}}, textString = "%name")}, coordinateSystem(extent = {{-100, -100}, {100, 100}})));
end DataTransfer;
